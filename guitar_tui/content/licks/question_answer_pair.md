...
slug: question_answer_pair
difficulty: intermediate
tags: [phrasing, blues, call-response, melodic]
key: A
scale: minor_pentatonic
backing_chords: [Am, G, F, E]
backing_progression: "i – bVII – bVI – V in A minor (1 bar each)"
category: phrasing
position: 1
summary: A two-phrase conversation - the question climbs to the b7 and hangs, the answer retraces the path and settles on the root. The gap between them is part of the lick.
---
...
Record **Am – G – F – E**, one bar each, 70–85 BPM. Play the question over the Am bar, rest through G, and deliver the answer across F so the final A arrives as E resolves back to Am.

## What to Listen For

The G at the top of the question is doing the asking — it is the b7, one whole step below the root, and the ear hears it as an unfinished thought. Do not shorten the rest that follows: the silence is where the listener leans in. The answer's arrival on A (D string, fret 7) should feel like the second half of a sentence, not a new idea.

...
slug: modes_in_context
difficulty: intermediate
tags: [scales, modes, music-theory, improvisation]
...
When you hear a long Dm chord, or a Dm – G – Dm – G loop that always returns to Dm as its resting place, you are likely in D Dorian (not C major moving to Dm). The difference is which note feels like *home*.

## The Relative Approach in Practice

All five CAGED positions of C major work for any of its seven modes, as long as you treat the right note as the root. Here is the modal map for one octave of C major:

| Mode | Root note | Where it falls in C major boxes |
|------|-----------|--------------------------------|
| Ionian (C major) | C | Root of every C major position |
| D Dorian | D | 2nd degree — find D in the box |
| E Phrygian | E | 3rd degree — find E |
| F Lydian | F | 4th degree — find F |
| G Mixolydian | G | 5th degree — find G |
...
Parallel thinking compares each mode directly to the major or minor scale from the same root:

- Dorian = natural minor + natural 6 (raise the b6 by one semitone)
- Phrygian = natural minor + b2 (lower the 2nd by one semitone)
...
| Progression feel | Likely mode | Why |
|-----------------|-------------|-----|
| Minor i – IV (major) | Dorian | IV major chord in a minor key |
| Minor i – bII | Phrygian | Half-step above tonic |
| Major I – II | Lydian | II major a whole step above I |
| Major I – bVII | Mixolydian | bVII major a whole step below I |
| Minor i – bVII – bVI | Aeolian (natural minor) | Descending minor scale movement |

The fastest way to identify the mode is to look at the chord immediately after the tonic chord. That movement almost always reveals the mode.
...
**Step 3** — Find that characteristic note in your current position and use it deliberately. Land on it, bend to it, and resolve from it.

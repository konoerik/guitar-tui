...
slug: guitar_anatomy
difficulty: beginner
tags: [equipment, gear, reference]
module: equipment
position: 1
summary: The names of the parts under your hands — so that "rest your palm on the bridge" and "fret behind the nut" mean something — plus what actually changes between classical, acoustic, and electric guitars.
---

## Why Names Matter

Lessons in this app say things like "rest your palm right where the strings meet the bridge" or "the nut is fret zero." Those sentences only work if the names are attached to the right places under your hands. Five minutes here saves confusion everywhere else.

## The Parts, Top to Bottom

**Headstock** — the top end, where the strings terminate at the **tuning machines** (also called tuners, tuning pegs, or machine heads). Turning a tuner changes that string's tension, and therefore its pitch — that is all tuning is.

**Nut** — the small slotted strip where the headstock meets the neck. The strings pass through its slots, and it defines one end of the vibrating string length. When a chord diagram shows fret 0, the "fret" is the nut.
...
**Electrics only:** **pickups** (magnetic sensors under the strings — the neck pickup sounds rounder, the bridge pickup brighter and tighter), a **pickup selector** switch, **volume and tone knobs**, and an **output jack** for the cable.

One part you should know exists but not touch: the **truss rod**, a steel rod inside the neck that counteracts string tension. If your neck seems bowed or the action (string height) feels wrong, that is a quick, cheap adjustment — for a guitar tech, not a first-timer.
...
The electric guitar in this lesson is nearly silent until it meets an amplifier — and the amp is not just volume, it is half the instrument. That is the next lesson.
